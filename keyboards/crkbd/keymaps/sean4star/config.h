...
#   define OLED_FONT_H "keyboards/crkbd/keymaps/sean4star/glcdfont.c"
...
// Space Saving
#undef LOCKING_SUPPORT_ENABLE		// if not using physically locking mod keys
#undef LOCKING_RESYNC_ENABLE		// if not using physically locking mod keys
#define NO_ACTION_ONESHOT			// if not using one shot mods or layers
